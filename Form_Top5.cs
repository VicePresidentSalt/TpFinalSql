...
namespace TPFinalSQLDEVCoteFrancisStlaurentDarenKen
{
    public partial class Form_Top5 : Form
    {
        ...
        private void FillTop5()
        {
            ...
            LB_1erePos.Text = DGV_Top5.Rows[0].Cells[2].Value.ToString() +" "+ DGV_Top5.Rows[0].Cells[1].Value.ToString();
            LB_2emePos.Text = DGV_Top5.Rows[1].Cells[2].Value.ToString() + " " + DGV_Top5.Rows[1].Cells[1].Value.ToString();
            LB_3emePos.Text = DGV_Top5.Rows[2].Cells[2].Value.ToString() + " " + DGV_Top5.Rows[2].Cells[1].Value.ToString();
            LB_4emePos.Text = DGV_Top5.Rows[3].Cells[2].Value.ToString() + " " + DGV_Top5.Rows[3].Cells[1].Value.ToString();
            LB_5emePos.Text = DGV_Top5.Rows[4].Cells[2].Value.ToString() + " " + DGV_Top5.Rows[4].Cells[1].Value.ToString();
        }
    }
}
